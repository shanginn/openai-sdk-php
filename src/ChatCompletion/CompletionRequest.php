...
final class CompletionRequest
{
     ...
     *                                                                   See more information about frequency and presence penalties.
     * @param ResponseFormat|null                     $responseFormat    Optional. An object specifying the format that the
     ...
     * @param array<class-string<ToolInterface>>|null $tools             Optional. A list of tools the model may call.
